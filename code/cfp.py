...
get_CenFreq(StartFreq=80, StopFreq=1000, NumPerOct=48)
    Returns:
        CenFreq:(list) A list for feature map to frequency

get_time(fs, Hop, end)
    Returns:
        time:(list) A list for feature map to time
...
def feature_extraction(x, fs, Hop=320, Window=2049, StartFreq=80.0, StopFreq=1000.0, NumPerOct=48):
